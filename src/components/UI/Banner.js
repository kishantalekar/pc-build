        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center text-gray-600">
          ...
          <div className="p-5 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center">
              {/* <button
                className="m-1.5 py-2.5 px-5 rounded-md bg-teal-300 text-white font-semibold uppercase hover:bg-teal-400"
                onClick={scrollToRef}
              >
                Shop now
              </button> */}
              <Link href="/pcbuilder" className="btn btn-lg btn-primary ml-5">
                PC Builder
              </Link>
            </div>
          </div>
